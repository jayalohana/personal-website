          ...
          <ExperienceList>
            ...
            <ExperienceItem>
              ...
              <ExperienceInfo>
                ...
                <ExperienceDescription>
                  <li>
                    • Utilizing React.js, TypeScript, and Next.js to build
                    scalable and modular components for the hackathon website,
                    enabling efficient state management and seamless integration
                    with the backend APIs.
                  </li>
                  <li>
                    • Employing modern frontend frameworks and libraries like
                    Vue.js and GraphQL to develop dynamic and interactive
                    features for the hackathon website, enhancing user
                    engagement and providing real-time data updates.
                  </li>
                </ExperienceDescription>
              </ExperienceInfo>
            </ExperienceItem>
